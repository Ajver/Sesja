function createSituations() {
	...
	"CLIENTT", 
	new Array(
	new Question("Na czym polega problem?", 0, 1, new Array(0, 0, 0)),
	new Question("Co Ty na to?", 1, 1, new Array(0, 0, 0)),
	new Question("Czy to jest pytanie?", 2, 0, new Array(0, 0, 0)),
	new Question("Czy to jest pytanie2?", 3, 0, new Array(0, 0, 0)),
	new Question("Czy to jest pytanie3? Aleee Nieee?", 4, 0, new Array(0, 0, 0)),
	new Question("Czy to jest jeszcze inne pytanie?", 5, 2, new Array(0, 0, 0))
	), 0));
